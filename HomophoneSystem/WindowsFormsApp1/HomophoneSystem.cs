...
{
    internal class HomophoneSystem
    {
        private Random rnd = new Random();
        private Dictionary<char, float> symbolFrequencyes;
        public Dictionary<char, List<string>> symbolCodes;

        public HomophoneSystem()
        {
            symbolFrequencyes =
        ...
        public void GenerateNewKeys()
        {
            ...
            symbolCodes = new Dictionary<char, List<string>>();
